...
<div class="isolate bg-white font-jura">
	<main>
		...
		>
			...
			>
				...
				<p class=" text-white">
					...
					our flexible staffing solutions can help fill the gap.
				</p>
				<div class="mt-8 flex gap-x-4">
					<a
						href="/contact"
			...
			>
				...
				<p class="text-white">
					...
					every aspect of the process, from initial setup to ongoing management and compliance.
				</p>
				<div class="mt-8 flex gap-x-4">
					<a
						href="/contact"
						class="transition ease-in-out duration-300 inline-block rounded-lg w-40 text-center bg-gray-400 bg-opacity-30 px-4 py-1.5 text-base font-semibold leading-7 backdrop-blur text-white ring-1 ring-white hover:bg-gray-700 hover:ring-red-800 no-underline"
					>
						Learn More
						<span class="text-red-200" aria-hidden="true">&rarr;</span>
					</a>
			...
			>
				...
				<p class="text-white">
					...
					and driving efficiency through Automation Design and Resources, we are committed to
					delivering strategic guidance that fuels growth and success.
				</p>
				<div class="mt-8 flex gap-x-4">
					<a
						href="/contact"
		...
		<!-- <section class="mx-auto min-h-[40vh] relative bg-gray-200">
			<h2 class="absolute my-6 sm:my-0 sm:top-14 font-bold text-center w-screen text-4xl">
				Testimonials
			</h2>
			<ReviewList {reviews} />
		</section> -->
