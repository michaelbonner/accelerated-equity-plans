...
<div class="isolate bg-white">
	<main>
		...
		<div class="relative px-6 lg:px-8 text-white bg-black h-content">
			<!-- Background Div -->
			<div
				class="absolute inset-0 bg-cover -z-1"
		...
		>
			<div class="py-14 sm:py-32">
				<div
					class="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 sm:gap-y-20 px-6 lg:px-8 xl:grid-cols-3"
				>
					...
					<ul
						role="list"
						class="grid grid-cols-1 gap-x-6 gap-y-10 sm:gap-y-20 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-8 xl:col-span-2"
					>
						<li
							class="h-full bg-slate-800 backdrop-blur-lg rounded-2xl bg-opacity-30 flex flex-col"
						>
							<img
							...
							<div class="px-4 py-4 flex flex-col flex-grow">
								...
								<p class="flex mt-4 text-base leading-7 text-white flex-grow">
									Emily's rich journey through equity compensation roles, combined with her
									Certified Equity Professional designation and MBA in Finance, makes her a trusted
									expert in enhancing the value and efficiency of equity plans for diverse
									organizations.
								</p>
						...
						>
							...
							<div class="px-4 py-4 flex flex-col flex-grow">
								...
								<p class="flex mt-4 text-base leading-7 text-white flex-grow">
									Neil's extensive experience with Deloitte and various equity firms, coupled with
									his CEP designation and Finance degree, uniquely positions him as a strategic
									architect in streamlining equity compensation across pivotal business functions
		...
		<section>
			<div
				class="relative isolate overflow-hidden bg-gray-900 px-6 py-14 text-center shadow-2xl sm:px-16 flex flex-col sm:flex-row items-center justify-between"
			>
				<h2 class="text-3xl font-bold tracking-wide text-white sm:text-4xl">
					Take your equity management to the next level today
				</h2>
				<div class="flex items-center justify-center gap-x-6 mt-8 sm:mt-0">
					<a
						href="/"
						class="inline-block rounded-lg w-40 text-center bg-red-700 bg-opacity-30 px-4 py-1.5 text-base font-semibold leading-7 text-white ring-1 ring-red-700 hover:bg-red-800 hover:ring-red-800 no-underline"
						>Learn More</a
					>
				</div>
				<svg
