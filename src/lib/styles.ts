...
export const styles = {
	h1Super: clsx(
		'text-5xl font-bold tracking-tight font-headings italic text-pretty',
		'sm:text-6xl',
		'lg:text-8xl'
	),
	h1: clsx(
		'text-4xl font-bold tracking-tight font-headings italic text-pretty',
		'sm:text-5xl',
		'lg:text-6xl'
	),
	h2: clsx('font-headings text-4xl italic text-pretty font-medium', 'sm:text-5xl'),
	h3: clsx('font-headings text-2xl italic text-pretty font-medium', 'sm:text-3xl'),
	h4: clsx('font-headings text-xl text-pretty font-medium', 'sm:text-2xl'),
	blackButton: clsx(
		'bg-black px-6 py-3 text-lg text-white rounded-md transition ease-in-out duration-300 cursor-pointer',
