  ...
  <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    <div class="flex flex-1">
      <div class="flex flex-col">
        <a href="/" class="text-sm font-semibold leading-8">Product</a>
        <a href="/" class="text-sm font-semibold leading-8">Features</a>
        <a href="/" class="text-sm font-semibold leading-8">Company</a>
      </div>
    </div>
